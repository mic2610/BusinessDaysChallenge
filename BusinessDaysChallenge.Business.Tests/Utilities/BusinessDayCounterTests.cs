...
using BusinessDaysChallenge.Business.Utilities;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace BusinessDaysChallenge.Business.Tests.Utilities
{
    public class BusinessDayCounterTests
    {
        ...
        public class WeekdaysBetweenTwoDates
        {
            ...
            {
                // Arrange
                var businessDayCounter = new Business.Utilities.BusinessDayCounter();
